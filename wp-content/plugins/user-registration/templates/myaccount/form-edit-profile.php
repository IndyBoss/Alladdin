		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				<div class="user-registration-profile-fields">
					<h2><?php _e( 'Profiel gegevens', 'user-registration' ); ?></h2>
					<?php
					...
					?>
						<div class="user-registration-profile-header">
							<div class="user-registration-img-container" style="width:100%">
								...
								<header>
									<p><strong><?php _e( 'Upload je nieuwe profielfoto.', 'user-registration' ); ?></strong></p>
									<div class="button-group">
										...
										<?php
											...
											<button class="button profile-pic-remove" style="<?php echo ( $gravatar_image === $image ) ? 'display:none;' : ''; ?>"><?php echo __( 'Verwijder', 'user-registration' ); ?></php></button>
											<?php
											if ( 'yes' === get_option( 'user_registration_ajax_form_submission_on_edit_profile', 'no' ) ) {
												?>
												<button type="button" class="button user_registration_profile_picture_upload hide-if-no-js" style="<?php echo ( $gravatar_image !== $image ) ? 'display:none;' : ''; ?>" ><?php echo __( 'Upload profielfoto', 'user-registration-advanced-fields' ); ?></button>
									...
									?>
										<span><i><?php echo __( 'Je kan je profielfoto wijzigingen op', 'user-registration' ); ?> <a href="https://en.gravatar.com/"><?php _e( 'Gravatar', 'user-registration' ); ?></a></i></span>
									<?php }  ?>
								</header>
							</div>
					<?php } ?>
					...
					<p>
						...
						if ( 'yes' === get_option( 'user_registration_ajax_form_submission_on_edit_profile', 'no' ) ) {
							?>
							<button type="submit" class="user-registration-submit-Button btn button <?php echo esc_attr( implode( ' ', $submit_btn_class ) ); ?>" name="save_account_details" ><span></span><?php esc_attr_e( 'Bewaar wijzigingen', 'user-registration' ); ?></button>
							<?php
						} else {
							wp_nonce_field( 'save_profile_details' );
							?>
							<input type="submit" class="user-registration-Button button <?php echo esc_attr( implode( ' ', $submit_btn_class ) ); ?>" name="save_account_details" value="<?php esc_attr_e( 'Bewaar wijzigingen', 'user-registration' ); ?>" />
